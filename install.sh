...
install_klipperscreen_panel() {
    ...
    # spoolman_common.py, tool_routing.py, touch_picker.py, and
    # sidebar_declutter.py are shared modules imported as siblings by the
    # actual Panel files — they need to be symlinked alongside them too,
    # not just the Panel files themselves.
    for f in filament_lanes.py filament_lanes_spoolman.py filament_lanes_manual.py \
             ...
             spoolman_common.py tool_routing.py touch_picker.py sidebar_declutter.py; do
